...
当前版本: v1.0.0
目标版本: v1.0.3
补丁�? [v1.0.0 �?v1.0.1, v1.0.1 �?v1.0.2, v1.0.2 �?v1.0.3]
策略: 服务端合并为一个补�?v1.0.0 �?v1.0.3
优势: 
  - 客户端只需下载一�?
  - 只需应用一次补�?
  - 减少出错概率
...
```json
{
  ...
  "patch": {
    ...
    "fileSize": 5242880,
    "patchCount": 3,
    "description": "合并补丁�?.0.0 �?1.0.3（包�?3 个补丁）"
  },
  "securityConfig": {
...
BFS 搜索结果:
路径1: v1.0.0 �?v1.0.1 �?v1.0.2 �?v1.0.3 (3个补�?
路径2: v1.0.0 �?v1.0.2 �?v1.0.3 (2个补�? �?最�?
